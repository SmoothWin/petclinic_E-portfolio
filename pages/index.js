...
export default function Home() {
  ...
  if(sprintSelected == null){
    ...
    containerContent = <div className="sprintContainer">Sprint 1<Section>Whatever I want</Section></div>
  }
  return (
    <div>
      <Head>
      ...
      <div id="wrapper">
      <nav><span className="navItem logo">Christian Chitanu's<br/>PetClinic E-Portfolio</span> <span className="navItem link"><a onClick={()=>selectSprint(1)}>Sprint 1</a></span></nav>
